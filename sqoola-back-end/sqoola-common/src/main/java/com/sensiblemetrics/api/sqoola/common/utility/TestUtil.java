...
public class TestUtil {
    ...
    /**
     * Default {@link MediaType} for JSON UTF8
     */
     ...
     * @throws IOException
     */
    public static byte[] convertObjectToJsonBytes(final ObjectMapper mapper, final Object object) throws IOException {
     ...
     * @return the JSON byte array
     */
    public static byte[] createByteArray(int size, final String data) {
    ...
    public static <T> void equalsVerifier(final Class<T> clazz) throws Exception {
        final T domainObject1 = clazz.getConstructor().newInstance();
        ...
        final T domainObject2 = clazz.getConstructor().newInstance();
