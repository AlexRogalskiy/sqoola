...
public class OffsetPageRequest implements Pageable {
    ...
    /**
     * Default offset page request constructor with initial input offset, limit arguments
     *
    ...
    /**
     * Default offset page request constructor with initial input offset, limit and sort arguments
     *
     * @param offset - initial offset input argument
     * @param limit  - initial limit input argument
     * @param sort   - initial sort input argument
     */
