...
import com.ubs.network.api.rest.core.controller.interfaces.ITaskGroupController;
...
@RestController("taskUnitController")
@RequestMapping({"/v3/", "/oauth2/v3/"})
@Api(value = "polls", description = "Poll API")
public class TaskGroupController<E extends TaskEntity, D extends TaskGroupDTO> extends CoreBaseController<E, D> implements ITaskGroupController<E, D> {
    @Inject
