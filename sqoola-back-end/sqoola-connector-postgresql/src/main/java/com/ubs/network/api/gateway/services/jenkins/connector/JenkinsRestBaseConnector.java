package com.ubs.network.api.gateway.services.jenkins.connector;
...
public class JenkinsRestBaseConnector<E extends IBaseEntity, D extends IBaseDTO> extends ARestBaseConnector<E, D> implements IJenkinsRestBaseConnector<E, D> {
